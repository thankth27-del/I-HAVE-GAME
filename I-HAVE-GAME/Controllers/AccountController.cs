    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            var user = new User
            {
                ...
                Nickname = null,
                MainDevice = null,
                PasswordHash = "" // Placeholder, will be set by HashPassword
            };
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            if (user == null)
            {
                ...
                _logger.LogWarning("Login attempt with non-existent credentials: {UsernameOrEmail}", model.UsernameOrEmail);
                return View(model);
            }
            ...
            // If user hasn't completed onboarding (Nickname not set), redirect to onboarding
        ...
        {
            _logger.LogInformation("User {Username} logged out.", User.FindFirst(ClaimTypes.Name)?.Value);
